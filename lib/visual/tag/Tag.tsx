...
const theme = {
    base: 'inline-flex items-center gap-sm border text-md font-medium cursor-default px-sm focus-within:outline-2 outline-offset-2 outline-primary disabled:cursor-not-allowed',
    variant: {
